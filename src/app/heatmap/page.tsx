...
import MapHeatmapLoader from "@/components/MapHeatmapLoader";
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">
                        Personal <span className="text-orange-600">Heatmap</span>
                    </h1>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">
                        Peta rekam jejak dari seluruh riwayat rute aktivitas jalan, lari, dan sepedamu.
                    </p>
                </div>
            </div>

            <MapHeatmapLoader activities={allActivities} />
        </main>
    );
}
